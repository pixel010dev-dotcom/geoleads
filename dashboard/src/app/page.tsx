        ...
        <section className="app-container py-16 sm:py-24">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {steps.map((step, i) => (
                <div key={i} className="app-card p-8 rounded-[2rem] text-center group hover:border-blue-500/30 transition-all duration-500">
        ...
        <section className="app-container py-16 sm:py-24">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {features.map((f, i) => (
                <div key={i} className="app-card p-6 rounded-2xl hover:border-white/15 transition-all">
